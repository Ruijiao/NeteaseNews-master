...
public class MainActivity extends FragmentActivity {
    ...
    private List<View> mCurrentItemList;
    private List<View> mAllItemList;
    ...
    private void initView() {
        ...
        mArrowButton = (ImageView) findViewById(R.id.indicator_arrow) ;
    ...
    private void initData() {
        ...
        for (int i = 0; i < INDICATOR_CURRENT_ITEM.length; i++) {
            View v = mInflater.inflate(R.layout.a_main_tab_item, mCurrentFlowLayout, false);
            TextView textView = (TextView) v.findViewById(R.id.a_main_tab_item_title);
            textView.setText(INDICATOR_CURRENT_ITEM[i]);
            mCurrentItemList.add(v);
            mCurrentFlowLayout.addView(v);
        }
    ...
    private void initEvent() {
        mArrowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mArrowButton.setImageResource(R.drawable.arrow_up);
        ...
        mIndicatorPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                mArrowButton.setImageResource(R.drawable.arrow_down);
            }
        });
        ...
        for (int i = 0; i < mCurrentItemList.size(); i++) {
            ...
            final View textView = mCurrentItemList.get(i);
        ...
        for (int i = 0; i < mAllItemList.size(); i++) {
            final View view = mAllItemList.get(i);
            final TextView textView = (TextView) view.findViewById(R.id.a_main_tab_item_title);
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //添加相应的标题
                    mCurrentItemList.add(view);
                    //通知适配器数据更新
                    mAdapter.notifyDataSetChanged();

                    mAllItemList.remove(view);
                    mAllFlowLayout.removeView(view);

                    mCurrentFlowLayout.addView(view);
                    //重新初始化点击事件
                    /**
